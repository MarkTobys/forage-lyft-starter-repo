...
class TestCalliope(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        wear = [0,0,0,0]
        car = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage, wear)
    ...
    def test_engine_should_be_serviced(self):
        ...
        last_service_mileage = 0
        wear = [0, 0, 0, 0]
        car = CarFactory.create_calliope(last_service_date, last_service_date, current_mileage, last_service_mileage, wear)
    ...
    def test_Tyres_should_be_serviced(self):
        ...
        wear = [1, 1, 1, 0]
        car = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage, wear)
        self.assertTrue(car.tyres.needs_service())
    ...
    def test_Tyres_should_not_be_serviced(self):
        ...
        wear = [0, 0, 0, 0]
        car = CarFactory.create_calliope(today, last_service_date, current_mileage, last_service_mileage, wear)
        self.assertFalse(car.tyres.needs_service())
...
class TestGlissade(unittest.TestCase):
    def test_battery_should_be_serviced(self):
        ...
        car = CarFactory.create_glissade(today, last_service_date, current_mileage, last_service_mileage, wear)
        self.assertTrue(car.battery.needs_service())
    ...
    def test_engine_should_be_serviced(self):
        ...
        car = CarFactory.create_glissade(last_service_date, last_service_date, current_mileage, last_service_mileage, wear)
        self.assertTrue(car.engine.needs_service())
    ...
    def test_tyers_should_be_serviced(self):
        last_service_date = datetime.today().date()
        current_mileage = 60000
        last_service_mileage = 0
        wear = [0, 0, 0, 0]
        ...
        car = CarFactory.create_glissade(last_service_date, last_service_date, current_mileage, last_service_mileage, wear)
        self.assertFalse(car.tyres.needs_service())
    def test_tyers_should_not_be_serviced(self):
        last_service_date = datetime.today().date()
        current_mileage = 60000
        last_service_mileage = 0
        wear = [0, 0, 0, 0.9]
